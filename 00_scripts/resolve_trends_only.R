...
#                         "Black-winged Kite")
# 
# species_to_process <- c("Red Junglefowl")
...
# trends files
trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_Oct27_18sp_1000_assign/", 
                     # Generate the full file paths
                     full.names = T)

trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_Nov4_all_sp_100_assign/", 
                     # Generate the full file paths
                     full.names = T)

trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_Nov4_only_reju_100_assign/", 
                     # Generate the full file paths
                     full.names = T)

trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_Nov5_only_reju_100_assign_sep26/", 
                     # Generate the full file paths
                     full.names = T) # With Sep 26 files
...
trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_rerun/", 
                     # Generate the full file paths
                     full.names = T)

trends <- list.files(path = "~/new_pipeline/soib_2023/01_analyses_full/trends/trends_Nov18_final_fixed/", 
                     # Generate the full file paths
                     full.names = T)
...
# Choose the first 500 trend files for comparison with predinterval = TRUE
trends_files <- trends_files[1:500]

# trends_files <- c("/home/praveen/new_pipeline/soib_2023/01_analyses_full/trends/trends_392.csv",
#                  "/home/praveen/new_pipeline/soib_2023/01_analyses_full/trends/trends_393.csv",
#                  "/home/praveen/new_pipeline/soib_2023/01_analyses_full/trends/trends_394.csv",
#                  "/home/praveen/new_pipeline/soib_2023/01_analyses_full/trends/trends_395.csv",
#                  "/home/praveen/new_pipeline/soib_2023/01_analyses_full/trends/trends_396.csv")
...
write.csv(trends, "01_analyses_full/trends_combined_3_sp_fixed.csv")
write.csv(trends, "01_analyses_full/trends_combined_18_sp_1000_assign.csv")
write.csv(trends, "01_analyses_full/trends_combined_all_sp_100_assign.csv")
write.csv(trends, "01_analyses_full/trends_combined_only_reju_sp_100_assign.csv")
write.csv(trends, "01_analyses_full/trends_combined_only_reju_sp_100_assign_sep26.csv")
write.csv(trends, "01_analyses_full/trends_combined_only_reju_sp_100_assign_fix_migyear.csv")
...
#write.csv(trends_combined, "01_analyses_full/trends_combined_fixed_reju.csv")
...
write.csv(trends, 
          file = "01_analyses_full/results/trends_Nov18_final_fixed_500_files.csv", 
          row.names = F)



################ Run this here for testing #########################
...
write.csv(main, 
          file = "01_analyses_full/results/SoIB_main_wocats_all_sp_run_18.csv", 
          row.names = F)
