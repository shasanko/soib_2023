...
to_walk <- function(.x,
  ...
  # cur_plot_base <- cur_plot_base +
  #   theme(
  #     plot.margin = margin(
  #       t = 40,   # top padding in points (adjust as needed)
  #       r = 10,
  #       b = 10,
  #       l = 10
  #     )
  #   )
  # 
  # cur_plot <- cowplot::ggdraw(cur_plot_base) +
  #   cowplot::draw_image(
  #     "SoIB_logo.png",
  #     x = 0.98,      # right edge
  #     y = 0.98,      # near top of full canvas
  #     hjust = 1,
  #     vjust = 1,
  #     width = 0.18
  #   )
  ...
  #   theme(
  #     plot.margin = margin(
  #       t = 60,   # top padding in points (adjust as needed)
  #       r = 10,
  #       b = 10,
  #       l = 10
  #     )
  ...
  save_size <- ifelse(cur_metadata$MASK.TYPE == "state", 8, 7)
  ...
  # ggsave(filename = "02_graphs/10_rangemaps/07_Andhra Pradesh/pitta.png",
  #        plot = cur_plot_base,
  #        dpi = 1000,
  #        bg = "white",
  #        width = 8,
...
soib_rangemap <- function(which_spec = "all",
  ...
  #stamp <- image_read("SoIB_logo.png")
  stamp_path <- "SoIB_logo.png"
