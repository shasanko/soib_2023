...
# write paths
lttsens_path <- "01_analyses_full/results/longterm_sensitivity_old_CI.RData"
cursens_path <- "01_analyses_full/results/current_sensitivity_old_CI.csv"
trends_outpath <- "01_analyses_full/results/trends_old_CI.csv"

mainwocats_path <- "01_analyses_full/results/SoIB_main_wocats_old_CI.csv"
